...
export default function CoutnryDetailsBannerHero({ title, image }) {
    ...
    return (
        <div className="relative overflow-hidden">
            ...
            {/* Left Content */}
            <Layout className='relative overflow-x-hidden w-full  flex flex-col lg:flex-row items-center gap-6 pb-16'>
                ...
                <div className="lg:w-1/2  mt-[60px]  lg:mt-[60px] relative w-full">
                    {/* Column Container */}
