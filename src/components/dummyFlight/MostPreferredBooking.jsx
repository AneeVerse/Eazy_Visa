...
{ code: "EZE", name: "Ministro Pistarini International Airport, Buenos Aires" },
  ...
  { code: "CXH", name: "Vancouver Harbour Flight Centre" },
  { code: "ZBB", name: "Boundary Bay Airport" },
  { code: "YPK", name: "Pitt Meadows Airport" },
  { code: "YNJ", name: "Langley Regional Airport" },
  ...
  { code: "YWG", name: "Winnipeg James Armstrong Richardson Int'l Airport" },
