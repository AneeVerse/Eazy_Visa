...
const AdsVisaBookingContent = () => {
  ...
  const handleFormSwitch = (type) => {
    ...
    router.replace(`/ads-visa/bookings?type=${normalized}`);
  };
...
export default AdsVisaBookingPage;
