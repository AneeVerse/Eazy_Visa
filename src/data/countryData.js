export const countryData = [
  {
    ...
    description:
      "Japan blends ancient traditions with cutting-edge technology, offering cherry blossoms, sushi, and bullet trains.",
...

  {
    ...
    landmark:
      "/images/landmarks/Budapest Parliament Building tourist places in Hungary Visa.jpg",
    landmarkName: "Budapest Parliament Building",

    altName: "Budapest Parliament Building tourist places in Hungary Visa",
    description:
      "Hungary is famous for its thermal baths, stunning architecture, and vibrant cultural scene.",
    visaType: "Sticker Visa",
    lengthOfStay: "Up to 90 days",
    validity: "6 months",
...

  {
    ...
    description:
      "Italy enchants visitors with its ancient ruins, Renaissance art, and culinary delights.",
  ...
  },
  {
    ...
    landmark:
      "/images/landmarks/Sagrada Familia tourist places in Spain Visa.webp",
    landmarkName: "Sagrada Familia",
    altName: "Sagrada Familia tourist places in Spain Visa",
    description:
      "Spain dazzles with its vibrant culture, stunning architecture, and beautiful Mediterranean coastline.",
  ...
  },
  {
    ...
    landmark:
      "/images/landmarks/Matterhorn tourist places in Switzerland Visa.webp",
    landmarkName: "Matterhorn",
    altName: "Matterhorn tourist places in Switzerland Visa",
    description:
      "Switzerland offers breathtaking Alpine scenery, precision watches, and world-famous chocolates.",
  ...
  },
  {
    ...
    landmark:
      "/images/landmarks/Windmills tourist places in Netherlands Visa.webp",
    landmarkName: "Windmills",
    altName: "Windmills tourist places in Netherlands Visa",
    description:
      "The Netherlands charms visitors with its iconic canals, tulip fields, and rich artistic heritage.",
  ...
  },
  {
    ...
    landmark:
      "/images/landmarks/Belem Tower tourist places in Portugal Visa.webp",
    landmarkName: "Belem Tower",
    altName: "Belem Tower tourist places in Portugal Visa",
    description:
      "Portugal enchants visitors with its golden beaches, historic landmarks, and world-famous port wine.",
  ...
  },
  {
    ...
    description:
      "Austria offers imperial palaces, Alpine ski resorts, and the cultural riches of Vienna - the city of music.",
    ...
    documentsRequired: [
      ...
      },
      {
        ...
        documents: ["Company invitation letter", "Commercial register extract"],
      },
    ],
  ...
  },
  {
    ...
    description:
      "Belgium delights visitors with medieval towns, world-class chocolates, and being the heart of EU politics.",
    ...
    rejectionReasons: [
      {
        ...
        description:
          "Applying in Belgium but spending most time elsewhere in Schengen",
        icon: "destination",
      },
      {
  ...
  },
  {
    ...
    description:
      "Greece offers sun-drenched islands, ancient ruins, and the birthplace of Western civilization.",
  ...
  },
  {
    ...
    landmark:
      "/images/landmarks/Geirangerfjord tourist places in Norway Visa.webp",
    landmarkName: "Geirangerfjord",
    altName: "Geirangerfjord tourist places in Norway Visa",
    description:
      "Norway mesmerizes with its dramatic fjords, northern lights, and vibrant Viking heritage.",
    ...
    rejectionReasons: [
      {
        ...
        description:
          "Lacking proper winter gear documentation for northern travel",
        icon: "winter",
      },
      {
        title: "Schengen First-Entry Rule",
        description:
          "Norway not being main destination for multi-country trips",
        icon: "itinerary",
      },
    ],
  ...
  },
  {
    ...
    description:
      "Denmark charms with hygge culture, colorful harbors, and being the birthplace of LEGO.",
  ...
  },
  {
    ...
    description:
      "Finland offers magical Northern Lights, midnight sun, sauna culture, and Santa Claus Village in Rovaniemi.",
    ...
    rejectionReasons: [
      ...
      },
      {
        ...
        description:
          "Using tourist attraction as accommodation proof without bookings",
        icon: "santa",
      },
    ],
  ...
  },
  {
    ...
    description:
      "Sweden delights with its archipelago landscapes, innovative design, and the original ABBA Museum.",
  ...
  },
  {
    ...
    description:
      "Iceland enchants with geothermal wonders, glaciers, volcanoes, and the magical Northern Lights.",
  ...
  },
  {
    ...
    description:
      "The United Kingdom invites you with its rich history, iconic landmarks like Big Ben, and world-class education and tourism opportunities.",
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "The visa can be valid for 6 months, 2 years, 5 years, or 10 years.",
      },
    ],
  ...
  },
  {
    ...
    description:
      "Turkey offers a blend of Eastern and Western culture, stunning landmarks like Hagia Sophia, vibrant bazaars, and historical treasures across two continents.",
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Yes, you can apply for a Turkey e-visa for certain nationalities.",
      },
      {
  ...
  },
  {
    ...
    description:
      "Georgia is a stunning blend of mountains, monasteries, and modern charm, attracting travelers with its rich culture, natural beauty, and warm hospitality.",
    ...
    rejectionReasons: [
      ...
      },
      {
        ...
        description:
          "Applicants with no prior international travel may face delays or rejection",
        icon: "passport",
      },
    ],
    ...
    faqs: [
      {
        ...
        answer:
          "Indian citizens need to apply for an e-visa or sticker visa before traveling.",
      },
      {
 ...
 
  {
    ...
    landmark:
      "/images/landmarks/Wawel Castle tourist places in Poland Visa.webp",
    landmarkName: "Wawel Castle",
    altName: "Wawel Castle tourist places in Poland Visa",
    description:
      "Poland fascinates with medieval old towns, hearty cuisine, and resilient historical sites from WWII.",
    ...
    rejectionReasons: [
      {
        ...
        description:
          "Poland not being main destination for multi-country trips",
        icon: "itinerary",
      },
      {
        title: "Currency Confusion",
        description:
          "Showing funds in złoty instead of required euro equivalent",
        icon: "currency",
      },
    ],
  ...
  },
  {
    ...
    landmark:
      "/images/landmarks/Marina Bay Sands tourist places in Singapore Visa.webp",
    landmarkName: "Marina Bay Sands",
    altName: "Marina Bay Sands tourist places in Singapore Visa",
    description:
      "Singapore dazzles with its futuristic skyline, multicultural cuisine, and immaculate green spaces.",
    ...
    documentsRequired: [
      ...
      },
      {
        ...
        documents: ["Company letter", "V39A form (if sponsored)"],
      },
    ],
  ...
  },
  {
    ...
    description:
      "Croatia entices travelers with its stunning Adriatic coastline, historic cities, and Mediterranean charm.",
...

  {
    ...
    description:
      "Malta blends rich history, Mediterranean charm, and stunning coastlines in a compact island paradise.",
...

  {
    ...
    description:
      "Germany offers rich cultural heritage, historic cities, and scenic landscapes with a world-class transport system.",
...

  {
    ...
    description:
      "The USA offers diverse experiences from the bright lights of New York to the natural wonders of the Grand Canyon and technological innovations of Silicon Valley.",
...

  {
    ...
    description:
      "South Korea combines futuristic cities, ancient palaces, K-pop culture, and world-renowned cuisine.",
